...
$l['pagemanager_edit_form_url_next_page']='URI parameter NEXT Page';
$l['pagemanager_edit_form_url_next_page_description']='This parameter will be used to point to a next page. If filled in then a Link towards this page will be added at the bottom of the content</strong>';
$l['pagemanager_edit_form_url_prev_page']='URI parameter PREVIOUS Page';
$l['pagemanager_edit_form_url_prev_page_description']='This parameter will be used to point to a previous page. If filled in then a Link towards this page will be added at the bottom of the content</strong>';
$l['pagemanager_edit_form_url_toc_page']='URI parameter Table Of Contents Page';
$l['pagemanager_edit_form_url_toc_page_description']='This parameter will be used to point to a Table Of Contents page. If filled in then a Link towards this page will be added at the bottom of the content</strong>';